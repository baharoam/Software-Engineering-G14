...
class comment(FastHttpUser):
    ...
    def t(self):
        with self.client.request(
            "POST",
            "/humhub/index.php?r=comment%2Fcomment%2Fpost",
            data="_csrf=nx-1cjEPgtu7TsiTLqAjW2n3urzUSkGCMO7R3Yg4-_PzXOcUV0i2q9kb-stF4mYtCKWO8K57csVUr4KE4lm4vg%3D%3D&objectModel=humhub%5Cmodules%5Ccomment%5Cmodels%5CComment&objectId=1&Comment%5Bmessage%5D=**Nikeeee%3Aheart_eyes%3A%3Aheart_eyes%3A%3Aheart_eyes%3A**",
            catch_response=True,
        ) as resp:
            pass
